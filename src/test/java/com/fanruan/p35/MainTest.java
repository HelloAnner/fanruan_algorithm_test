...
public class MainTest {
    ...
    public void test1() throws Exception {
        testActually("src/test/java/com/fanruan/p35/LCS1-1.in", "src/test/java/com/fanruan/p35/LCS1-1.out");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test2() throws Exception {
        testActually("src/test/java/com/fanruan/p35/LCS1-10.in", "src/test/java/com/fanruan/p35/LCS1-10.out");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test3() throws Exception {
        testActually("src/test/java/com/fanruan/p35/LCS1-11.in", "src/test/java/com/fanruan/p35/LCS1-11.out");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test4() throws Exception {
        testActually("src/test/java/com/fanruan/p35/LCS2-1.in", "src/test/java/com/fanruan/p35/LCS2-1.out");
    }
