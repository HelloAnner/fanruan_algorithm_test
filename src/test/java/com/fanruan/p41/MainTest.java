...
public class MainTest {
    ...
    public void test1() throws Exception {
        testActually("src/test/java/com/fanruan/p41/1.in", "src/test/java/com/fanruan/p41/1.out");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test2() throws Exception {
        testActually("src/test/java/com/fanruan/p41/2.in", "src/test/java/com/fanruan/p41/2.out");
    }
    ...
    public void test3() throws Exception {
        testActually("src/test/java/com/fanruan/p41/3.in", "src/test/java/com/fanruan/p41/3.out");
    }
