...
public class MainTest {
    ...
    public void test1() throws Exception {
        testActually("src/test/java/com/fanruan/p32/1.in", "src/test/java/com/fanruan/p32/1.out");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test2() throws Exception {
        testActually("src/test/java/com/fanruan/p32/2.in", "src/test/java/com/fanruan/p32/2.out");
    }
    ...
    public void test3() throws Exception {
        testActually("src/test/java/com/fanruan/p32/3.in", "src/test/java/com/fanruan/p32/3.out");
    }
