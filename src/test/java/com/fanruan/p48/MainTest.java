...
public class MainTest {
    ...
    public void test1() throws Exception {
        testActually("src/test/java/com/fanruan/p48/rand1.in", "src/test/java/com/fanruan/p48/rand1.ans");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test2() throws Exception {
        testActually("src/test/java/com/fanruan/p48/rand2.in", "src/test/java/com/fanruan/p48/rand2.ans");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test3() throws Exception {
        testActually("src/test/java/com/fanruan/p48/rand3.in", "src/test/java/com/fanruan/p48/rand3.ans");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test4() throws Exception {
        testActually("src/test/java/com/fanruan/p48/rand4.in", "src/test/java/com/fanruan/p48/rand4.ans");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test5() throws Exception {
        testActually("src/test/java/com/fanruan/p48/rand5.in", "src/test/java/com/fanruan/p48/rand5.ans");
    }
