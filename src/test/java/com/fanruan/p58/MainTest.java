...
public class MainTest {
    ...
    public void test1() throws Exception {
        testActually("src/test/java/com/fanruan/p58/1.in", "src/test/java/com/fanruan/p58/1.out");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test2() throws Exception {
        testActually("src/test/java/com/fanruan/p58/2.in", "src/test/java/com/fanruan/p58/2.out");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test3() throws Exception {
        testActually("src/test/java/com/fanruan/p58/3.in", "src/test/java/com/fanruan/p58/3.out");
    }

    @Test
    @Timeout(value = LIMIT, unit = TimeUnit.MILLISECONDS)
    public void test4() throws Exception {
        testActually("src/test/java/com/fanruan/p58/4.in", "src/test/java/com/fanruan/p58/4.out");
    }
